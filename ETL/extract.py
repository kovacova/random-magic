...
connection = create_connection("./recommendation.sqlite")
...
(97, 'Foundations of Predictive Analytics in Python (Part 1)',
 'In this course, you will learn how to build a logistic regression model with meaningful variables. You will also learn how to use this model to make predictions and how to present it and its performance to business stakeholders.', 'python'),
